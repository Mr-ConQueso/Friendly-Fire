...
public class BlurRendererFeature1 : ScriptableRendererFeature
{
    ...
    {
        _blurRenderPass.Setup(renderer.cameraColorTargetHandle, gaussianBlurShader);// use of target after allocation
    }
